...
public class UploadPerformanceDataServiceImpl implements UploadPerformanceDataService {
	...
	@Autowired
	private WebServiceTemplate edwServicesTemplate;
	...
	public Object execute(String edCodeText, String cutOffDateText, String signatureDataText, 
		...
		return (UploadPerformanceDataResponse)edwServicesTemplate.marshalSendAndReceive(serviceEndpoint, requestPayload, 
				callback);
	}
